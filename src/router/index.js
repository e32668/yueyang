...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      },
      {
        path: 'markdownEditer',
        name: 'markdownEditer',
        component: () => import('@/views/markdown/markdownEditer'),
        meta: { title: '编辑器', icon: 'form' },
        hidden: true
      }
    ]
    ...
    children: [
      {
        path: 'index',
        name: 'leaveMassage',
        component: () => import('@/views/leaveMassage/index'),
  ...
  //       component: () => import('@/views/userAccountFlow/index'),
  //       meta: { title: '用户流水管理', icon: 'form' }
  //     }
  //   ]
  // }
]
