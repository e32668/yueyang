<template>
  <div class="components-container">
    ...
    <!-- <el-button style="margin-top:80px; margin-left:80px;" type="primary" icon="el-icon-document" @click="getHtml">
      Get HTML
    </el-button> -->
    <el-button style="margin-left:40px;" type="primary" icon="el-icon-document" @click="confirm">
      提交
    </el-button>
    <div v-html="html" />
  </div>
