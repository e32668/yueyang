      ...
      <el-card class="box-card no-padding">
        ...
        <el-row :span="24">
          ...
          >
            ...
            <el-table-column prop="id" label="留言ID" min-width="150" />
            <el-table-column prop="created" label="留言时间" min-width="150" />
            <el-table-column prop="content" label="留言内容" min-width="150" />
...
<script>
import { listByCondition, add, update, deleteArticle } from "@/api/leaveMessage";
